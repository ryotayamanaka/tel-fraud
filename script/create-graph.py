...
fa.write('acc_id,tel_number,cst_id,is_suspect,is_victim\n')
...
for node in range(num_node):
    ...
    fa.write(','.join([
        str(node), # ID
        '0' + str(random.randrange(70, 90, step=10)) + '-' + str(random.randrange(1000, 9999)) + '-' + str(random.randrange(1000, 9999, step=3)), # Number 
